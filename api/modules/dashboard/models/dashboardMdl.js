...
exports.getMonthlyAnalyticsMdl = function(data) {
    const monthsRaw = data.months || 6;
    const months = Number.isFinite(+monthsRaw) ? Math.max(0, parseInt(monthsRaw, 10)) : 6;
...
exports.getFavoriteStationsAnalyticsMdl = function(data) {
    ...
    const PARAMS = [data.userId, data.userId];
...
exports.getNearbyStationsMdl = function(data) {
    const limitRaw = data.limit || 3;
    const limit = Number.isFinite(+limitRaw) ? Math.max(0, parseInt(limitRaw, 10)) : 3;
